...
if is_sentencepiece_available():
    _import_structure["tokenization_canine_xlm_roberta"] = ["CanineXLMRobertaTokenizer"]


if is_torch_available():
    _import_structure["modeling_canine_xlm_roberta"] = [
...
if TYPE_CHECKING:
    ...
    if is_sentencepiece_available():
        from .tokenization_canine_xlm_roberta import CanineXLMRobertaTokenizer

    if is_torch_available():
        from .modeling_canine_xlm_roberta import (
            CanineXLMRobertaForCausalLM,
            CanineXLMRobertaForMaskedLM,
            CanineXLMRobertaForMultipleChoice,
            CanineXLMRobertaForQuestionAnswering,
