...
class CanineXLMRobertaForCausalLM(RobertaForCausalLM):
    """
...
class CanineXLMRobertaForMaskedLM(RobertaPreTrainedModel):
    """
    ...
    def __init__(self, config):
        ...
        self.lm_head = CanineRobertaLMHead(config)
...
class CanineRobertaLMHead(nn.Module):
...
class CanineXLMRobertaForSequenceClassification(RobertaForSequenceClassification):
    """
...
class CanineXLMRobertaForMultipleChoice(RobertaForMultipleChoice):
    """
...
class CanineXLMRobertaForTokenClassification(RobertaForTokenClassification):
    """
...
class CanineXLMRobertaForQuestionAnswering(RobertaForQuestionAnswering):
    """
