...
if is_sentencepiece_available():
    _import_structure["tokenization_sde_xlm_roberta"] = ["SDEXLMRobertaTokenizer"]


if is_torch_available():
    _import_structure["modeling_sde_xlm_roberta"] = [
...
if TYPE_CHECKING:
    ...
    if is_sentencepiece_available():
        from .tokenization_sde_xlm_roberta import SDEXLMRobertaTokenizer

    if is_torch_available():
        from .modeling_sde_xlm_roberta import (
            SDEXLMRobertaForCausalLM,
            SDEXLMRobertaForMaskedLM,
            SDEXLMRobertaForMultipleChoice,
            SDEXLMRobertaForQuestionAnswering,
