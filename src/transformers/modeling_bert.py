...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids=None, token_type_ids=None, position_ids=None, inputs_embeds=None):
        ...
        #    if dp_masks is None:
        #        mask1 = torch.zeros_like(embeddings).bernoulli_(1 - self.dp_prob) / (1 - self.dp_prob)
        #    else:
        #        mask1 = dp_masks
...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        #if self.training and self.dp_prob > 0:
        #    if dp_mask is None:
        #        mask = torch.zeros_like(attention_probs).bernoulli_(1 - self.dp_prob) / (1 - self.dp_prob)
        #    else:
        #        mask = dp_mask
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(
        ...
        #return outputs, [emb_dp_mask, encoder_dp_mask] # sequence_output, pooled_output, (hidden_states), (attentions)
        return outputs
